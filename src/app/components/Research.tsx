...
const Research = () => {
    return (
        <div className='bg-[#0C0C0C] flex flex-col gap-10 p-5 sm:px-28'>
            <div className="flex flex-col  gap-3">
                <h6 className='uppercase text-white font-semibold'> our research</h6>
                <p className='text-xl sm:text-4xl text-white font-medium '>We are pioneering general-purpose <br className='hidden sm:inline-flex' /> multimodal simulators of the world.</p>
