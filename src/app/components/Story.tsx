...
const Story = () => {
    return (
        <div className='h-full w-full flex flex-col gap-5 items-center bg-black px-5  py-20'>
            <h6 className='font-bold text-white'>runway <span className=''>Studios</span></h6>
            <h4 className={`font-[timesNow] text-[6vw] md:leading-20 text-center text-white`}>For anyone with <br />
                a story to tell.</h4>
            ...
            <h4 className='text-white text-4xl text-center'>Runway Studios is the entertainment and production arm of Runway, <br />
                dedicated to producing and funding films, documentaries, <br />
