...
const Research = () => {
    return (
        <div className='bg-black flex flex-col gap-10 p-5 sm:p-20'>
            <div className="flex flex-col items-center gap-3">
                <h6 className='uppercase text-white'> our research</h6>
                <p className='text-3xl text-white'>We are pioneering general-purpose <br className='hidden sm:inline-flex' /> multimodal simulators of the world.
                </p>
