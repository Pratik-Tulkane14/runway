...
const Story = () => {
    return (
        <div className='h-full w-full flex flex-col gap-10 items-center bg-[#0C0C0C] px-5  sm:py-20'>
            <h6 className='font-bold text-white text-2xl'>runway <span className='font-light'>Studios</span></h6>
            <h4 className={`font-[timesNow] text-[12vw] sm:text-[11vw] leading-10 sm:leading-36 text-center text-white`}>For anyone with <br />
                a story to tell.</h4>
            <div className="flex justify-center">
                <VideoUi source="/videos/teaser3.webm" style="sm:w-[70vw]" poster='/images/jeepPoster.jpg' />
            </div>
