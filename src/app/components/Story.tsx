...
const Story = () => {
    return (
        <div className='h-full w-full flex flex-col gap-10 items-center bg-[#0C0C0C] px-5  sm:py-20'>
            ...
            <h4 className={`font-[timesNow] text-[12vw] leading-10 sm:leading-28 text-center text-white`}>For anyone with <br />
                a story to tell.</h4>
            <div className="flex justify-center">
                <VideoUi source="/videos/hero.mp4" style="sm:w-[70vw]" poster='' />
            </div>
